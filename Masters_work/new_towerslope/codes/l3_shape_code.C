...
void Run1(int stats, const string& output_file)
{
    ...
    testslope(stats, 0.75, 0.5, 1.2, c1, c1a);
    testslope(stats, 1.0, 0.5, 1.2, c2, c2a);
    testslope(stats, 1.25, 0.5, 1.2, c3, c3a);
    testslope(stats, 0.75, 1.4, 3.0, c4, c4a);
    testslope(stats, 1.0, 1.4, 3.0, c5, c5a);
    testslope(stats, 1.25, 1.4, 3.0, c6, c6a);
